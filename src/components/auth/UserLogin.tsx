            ...
            <div>
              ...
              <div className="relative mt-1.5">
                ...
                <input
                  ...
                  className="w-full rounded-2xl border border-slate-200 bg-slate-50 py-3 pr-10 pl-3 text-sm text-slate-900 placeholder-slate-400 focus:bg-white focus:border-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-600/20 dark:border-[#1b2b4d] dark:bg-[#060c18] dark:text-white dark:placeholder-zinc-500 dark:focus:border-blue-500 transition-all font-mono"
                />
              </div>
            </div>
